...
export const ToastModal = () => {
  ...
  return (
    <motion.div
      ...
      variants={variants}
      onClick={hideModal}
      className={`cursor-pointer z-[999] fixed top-0 left-[50%] py-2 px-5 min-w-[80%] md:min-w-[30%] text-center text-white rounded whitespace-pre-wrap select-none ${color}`}
    >
      {messageOnToast}
    </motion.div>
  );
