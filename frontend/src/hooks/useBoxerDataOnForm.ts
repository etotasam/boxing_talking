...
export const useBoxerDataOnForm = () => {
  ...
  // const isBoxerDataOnFormType = (data: BoxerType | typeof innerSetter): data is BoxerType => {
  //   if (typeof data !== "function") {
  //     return _.every(data.titles, _.isObject)
  //   }
  //   return false
  // }
  ...
  // const setter = (argData: ((arg: BoxerType) => void)) => {
